...
<html lang="en">
  <head>
    ...
    <title>PT. Sirukam | Data SPK Alternatif</title>
    ...
    <div class="content">
      ...
      <div class="cards">
        ...
        <div class="sub-header">
          <div class="button1">
            <p><a href="cetak_karyawan_alternatif.php">Cetak</a></p>
          </div>
          <div class="button2">
        ...
        <h3>Alternatif</h3>
        <div class="button">
          <p><a href="input_alternatif.php">Tambah</a></p>
        </div>
                ...
                while ($hasil = mysqli_fetch_array($sql))
                {
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;"><?php echo "$hasil[alternatif]" ?></td>
                      ...
                      <td style="text-align:center;"><?php echo "<a style='text-decoration:none;' href='edit_alternatif.php?id_data=$hasil[id_data]'>Edit</a>" ?></td>
                      <td style="text-align:center;"><?php echo "<a style='text-decoration:none;' href='hapus_alternatif.php?id_data=$hasil[id_data]' onclick='return hapus()'>Hapus</a>" ?></td>
                    </tr>
                  <?php
                }
              }
