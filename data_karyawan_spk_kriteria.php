    ...
    <div class="content">
      ...
      <div class="cards">
        ...
        <div class="sub-header">
          <div class="button1">
            <p><a href="cetak_karyawan_kriteria.php">Cetak</a></p>
          </div>
          <div class="button2">
                ...
                while ($hasil = mysqli_fetch_array($sql))
                {
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo "$hasil[jenis_kriteria]" ?></td>
                      <td style="text-align:center;"><?php echo "$hasil[bobot]" ?></td>
                      <td style="text-align:center;"><?php echo "<a style='text-decoration:none;' href='edit_kriteria.php?id_data=$hasil[id_data]'>Edit</a>" ?></td>
                    </tr>
                  <?php
                }
              }
